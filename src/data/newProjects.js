...
const newProjects = [
  { image: Servidor, title: "Store", description: 'API no padrão REST para adicionar, ler, deletar e atualizar produtos e vendas no estoque', github: 'https://github.com/Kecbm/store-manager' },
