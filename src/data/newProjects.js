...
const newProjects = [
  { image: Servidor, title: "Store", description: 'Uma API no padrão REST onde é possível adicionar, ler, deletar e atualizar produtos e vendas no estoque', github: 'https://github.com/Kecbm/store-manager' },
