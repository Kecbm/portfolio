...
const projects = [
  ...
  { image: Lista, title: 'Todo list', description: 'Aplicação de lista de tarefas usando HTML, CSS e JavaScript', deploy: 'https://kecbm.github.io/todo-list/', github: 'https://github.com/Kecbm/todo-list' },
  ...
  { image: Cartas, title: 'YU-GI-OH!', description: 'Aplicação que simula o famoso jogo de cartas YU-GI-OH!', deploy: 'https://codepen.io/klecianny-melo/pen/yLXqXRN', github: 'https://codepen.io/klecianny-melo/pen/yLXqXRN' },
  ...
  { image: Mentalista, title: 'Mentalista', description: 'Jogo para adivinhação de um número aleatório entre 0 e 10', deploy: 'https://codepen.io/klecianny-melo/pen/GREydvM', github: 'https://codepen.io/klecianny-melo/pen/GREydvM' },
  { image: Conversor, title: 'Conversor de moeda', description: 'Aplicação que converte qualquer valor de real para bitcoin', deploy: 'https://codepen.io/klecianny-melo/pen/qBjVwoR', github: 'https://codepen.io/klecianny-melo/pen/qBjVwoR' },
  { image: Calculadora, title: 'Calculadora de média', description: 'Calculadora que recebe notas e informa a média escolar de um usuário', deploy: 'https://codepen.io/klecianny-melo/pen/bGRYLME', github: 'https://codepen.io/klecianny-melo/pen/bGRYLME' }
];
